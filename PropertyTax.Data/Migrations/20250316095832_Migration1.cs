            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PropertyNumber = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    AverageMonthlyIncome = table.Column<double>(type: "double", nullable: false),
                    RequestDate = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    Status = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CalculatedArnona = table.Column<double>(type: "double", nullable: false),
                    ApprovedArnona = table.Column<double>(type: "double", nullable: false)
                },
                constraints: table =>
                {
